...
public struct RTVIMessageInbound: Codable {
    ...
    public enum MessageType {
        ...
        static let BOT_LLM_STARTED = "bot-llm-started" // Unused
        /// LLM transcript from the bot has stopped
        static let BOT_LLM_STOPPED = "bot-llm-stopped" // Unused
        
        /// TTS transcript from the bot
        static let BOT_TTS_TEXT = "bot-tts-text"
        /// LLM transcript from the bot
        static let BOT_TTS_STARTED = "bot-tts-started" // Unused
        /// LLM transcript from the bot
        static let BOT_TTS_STTOPED = "bot-tts-stopped" // Unused
